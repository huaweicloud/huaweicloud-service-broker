...
Provision a new instance for RDS SQLServer Service.
...
| ha_replicationmode           | string     | N         | Specifies the replication mode for the standby DB instance. The value cannot be empty. For Microsoft SQL Server, the value is sync.
