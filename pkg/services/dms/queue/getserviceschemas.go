			...
			ServiceInstances: brokerapi.InstanceSchemas{
				ProvisioningParametersSchema: brokerapi.InputParametersSchema{
					...
					PropertySchemas: map[string]brokerapi.PropertySchema{
						"queue_name": &brokerapi.StringPropertySchema{
						...
						"group_name": &brokerapi.StringPropertySchema{
						...
						"redrive_policy": &brokerapi.StringPropertySchema{
						...
						"max_consume_count": &brokerapi.IntPropertySchema{
			...
			ServiceInstances: brokerapi.InstanceSchemas{
				ProvisioningParametersSchema: brokerapi.InputParametersSchema{
					...
					PropertySchemas: map[string]brokerapi.PropertySchema{
						...
						"retention_hours": &brokerapi.IntPropertySchema{
